    ...
    <div className="w-full overflow-hidden">
      <section className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute z-10 w-full h-full flex flex-col md:flex-row items-center justify-between px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 2xl:px-28 3xl:px-40 4xl:px-64 4k:px-96 text-white">
          ...
          {/* LEFT */}
          <div className="w-full md:w-1/2 flex flex-col justify-center h-full space-y-3 sm:space-y-4 md:space-y-6 lg:space-y-8 4xl:space-y-12 4k:space-y-16 pl-5">
            <h1 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl 2xl:text-6xl 3xl:text-7xl 4xl:text-8xl 4k:text-10xl font-extrabold drop-shadow-lg leading-tight">
              Capture Your Bump
            </h1>

            <div className="min-h-[3rem] md:min-h-[4rem] 4xl:min-h-[6rem] 4k:min-h-[8rem]">
              <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl 2xl:text-4xl 3xl:text-5xl 4xl:text-6xl 4k:text-8xl font-bold drop-shadow-lg text-pink-500">
                {languages[currentLang].text}
              </p>
            </div>

            <p className="text-sm sm:text-base md:text-lg lg:text-xl 2xl:text-2xl 3xl:text-3xl 4xl:text-4xl 4k:text-6xl drop-shadow-lg max-w-3xl 4xl:max-w-6xl 4k:max-w-8xl mt-[-10px]">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3 mt-2 4xl:mt-6 4k:mt-10">
              <Link
                href="/#Contact"
                className="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-3 sm:py-2.5 sm:px-4 rounded-lg shadow text-xs sm:text-sm md:text-base 2xl:text-lg 3xl:text-xl 4xl:text-2xl 4k:text-4xl transition-colors duration-300"
              >
                Book Your Session
              </Link>
              <Link
                href="/#gallery"
                className="border-2 border-white text-white hover:bg-white hover:text-pink-500 font-bold py-2 px-3 sm:py-2.5 sm:px-4 rounded-lg shadow text-xs sm:text-sm md:text-base 2xl:text-lg 3xl:text-xl 4xl:text-2xl 4k:text-4xl transition-colors duration-300"
              >
                View Gallery
              </Link>
            </div>
          ...
          {/* RIGHT */}
          <div className="w-full md:w-1/2 flex flex-col items-center md:items-end gap-4 sm:gap-6 md:gap-8 4k:gap-12 mt-6 sm:mt-8 md:mt-0">
            <div className="flex flex-col md:items-end gap-4 sm:gap-6 md:gap-8 4k:gap-12 w-full mt-6 sm:mt-8 md:mt-0">

              {/* Overlapping Images */}
              <div className="flex items-center justify-center md:justify-end gap-3 sm:gap-4 md:gap-6 4k:gap-8">
                <div className="flex -space-x-2 sm:-space-x-3 md:-space-x-4 4k:-space-x-6">
                  {stackedImages.map((src, i) => (
                    <motion.div
                      key={i}
                      whileHover={{ scale: 1.1, zIndex: 10 }}
                      className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 2xl:w-16 3xl:w-20 3xl:h-20 4xl:w-24 4xl:h-24 4k:w-32 4k:h-32 rounded-full overflow-hidden border-2 border-white bg-white shadow-md cursor-pointer"
                ...
                <div className="text-white text-xs sm:text-sm md:text-base 2xl:text-lg 3xl:text-xl 4xl:text-2xl 4k:text-4xl whitespace-nowrap">
                  <p className="font-extrabold text-sm sm:text-lg md:text-xl lg:text-2xl 3xl:text-3xl 4xl:text-4xl 4k:text-6xl text-pink-400">1000+ clients</p>
              ...
              <AnimatePresence mode="wait">
                <div className="shadow-xl rounded-2xl w-2/3 2xl:w-1/2 mr-5 4k:w-2/5">
                  ...
                  >
                    ...
                    <p className="italic text-xs text-white sm:text-sm md:text-base 2xl:text-lg 3xl:text-xl 4xl:text-2xl 4k:text-4xl mb-1 sm:mb-2 4k:mb-4">"{text}"</p>
