...
const languages = [
  ...
  { text: 'സ്നേഹം ഇരുവരിൽ തുടങ്ങുന്നു.' },
];
const reviews = [
...
export default function HeroSection() {
  ...
  return (
    <div className="w-full overflow-x-hidden">
      <section className="relative w-full md:min-h-screen h-auto min-h-[50vh] sm:min-h-[90vh]">
       {/* Background */}
<div className="absolute inset-0 z-0 overflow-hidden">
  <div className="relative w-full h-[80vh] sm:h-[90vh] md:h-full">
    <Image
